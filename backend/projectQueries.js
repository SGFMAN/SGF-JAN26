...
/**
 * @param {boolean|string} modeOrUseLite
 *   true / "lite" → lite
 *   false / "full" → full
 *   "card" → card projection
 */
function buildProjectsListQuery(modeOrUseLite = true) {
  let cols = PROJECT_LIST_COLUMNS;
  if (modeOrUseLite === false || modeOrUseLite === "full") {
    cols = PROJECT_SELECT_COLUMNS;
  } else if (modeOrUseLite === "card") {
    cols = PROJECT_CARD_COLUMNS;
  } else {
    cols = PROJECT_LIST_COLUMNS;
  }
