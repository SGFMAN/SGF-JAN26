...
export default function Cancelled() {
  ...
  function getFilteredProjects() {
    // Only show "Cancelled" projects
    let filtered = projects.filter((project) => project.status === "Cancelled");
      ...
      >
        ...
        >
          <h2 style={{ fontSize: "1.15rem", marginTop: 0, color: MONUMENT, marginBottom: "16px" }}>
            Cancelled {(() => {
              const totalCount = projects.filter((project) => project.status === "Cancelled").length;
              if (searchQuery.trim()) {
